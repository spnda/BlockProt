...
object Util {
     ...
     * @param end The end index inside of the given Array. Defaults to the size of the Array
     * @throws IllegalArgumentException if the `begin` is larger than `end` or if `end` is larger than the array's size
     */
    fun concatArrayRange(arr: Array<String>, begin: Int = 0, end: Int = arr.size): String {
        ...
        if (end > arr.size) throw IllegalArgumentException("end index cannot be larger than the size of the array")
